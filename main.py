...
from strategies import (
    BaseStrategy, Signal, MACrossoverStrategy, RSIMeanReversionStrategy,
    BollingerBandStrategy, MomentumStrategy, MACDStrategy, EnsembleStrategy,
    get_strategy
)
from advanced_strategies import (
    StatArbStrategy, MLAlphaStrategy, MultiFactorStrategy,
...
def main():
    ...
    parser.add_argument("--strategy", default="omega",
    ...
    if args.strategy == "ensemble":
        ...
        strategy_list = [get_ai_strategy(args.strategy)]
    else:
